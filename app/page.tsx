const products = [
  { title: "Арматура", code: "HRB400 · HRB500", img: "/images/rebar.jpg", pos: "center center", text: "Рифлёная и гладкая арматура для жилого, промышленного и инфраструктурного строительства." },
  { title: "Листовой прокат", code: "ГОСТ · ASTM · EN", img: "/images/sheet.jpg", pos: "center center", text: "Горячекатаный, холоднокатаный, оцинкованный лист и сталь специального назначения." },
  { title: "Рулонная сталь", code: "HRC · CRC · GI", img: "/images/coil.jpg", pos: "center center", text: "Рулоны для металлообработки, профилирования и серийного промышленного производства." },
  { title: "Трубы и профиль", code: "Круглые · профильные", img: "/images/pipes.jpg", pos: "center center", text: "Трубный, сортовой и фасонный прокат для строительных и производственных задач." },
];
  ...
  return <main id="top">
    ...
    <section className="heroSection">
      ...
      <div className="heroInner">
        <div className="heroText">
          ...
          <h1>МЕТАЛЛОПРОКАТ<br/>НАПРЯМУЮ<br/>ИЗ <em>КИТАЯ</em></h1>
          <p>В наличии и на заказ — любой объём. Берём заявки от одной тонны, без минимального порога.</p>
    ...
    <section className="aboutSection" id="about">
      ...
      <div className="aboutContent">
        ...
        <a className="certCard" href="/cert-rebar-14.pdf" target="_blank" rel="noreferrer" aria-label="Открыть сертификат качества арматуры Φ14">
          <div className="certCardIcon" aria-hidden="true">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="22" height="22"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
          </div>
          <div className="certCardBody">
            <b>Сертификат качества</b>
            <span>Арматура Φ14 · Xinjiang Bayi Steel · ГОСТ 34028-2016</span>
          </div>
          <span className="certCardArrow" aria-hidden="true">↗</span>
        </a>
